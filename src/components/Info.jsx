...
export const Info = () => {
  return (
    <Container style={{ paddingTop: "40px" }}>
      ...
      <Row style={{ marginBottom: "40px" }}>For any kinds of inquiries feel free to contact him:</Row>
      <Row style={{ marginBottom: "15px" }}>@joschka_moser</Row>
      <Row style={{ marginBottom: "15px" }}>+49 15157837059</Row>
      <Row style={{ marginBottom: "15px" }}>joschka.moser@web.de</Row>
    </Container>
  )
}